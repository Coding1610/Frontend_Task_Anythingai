  ...
  return (
    <div className="hero-gradient min-h-screen flex flex-col justify-center items-center px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-zinc-900 via-darkRed to-midRed animate-fade-in">
          Welcome
        </h1>
        
        <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
        Everything you need to authenticate users, protect routes, and manage data all in one place
        </p>
