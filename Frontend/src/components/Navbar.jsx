...
import { RouteProfileAdmin, RouteProfileUser, RouteLandingPage, RouteUploadFile } from "@/helpers/RouteName";
        ...
        <div className="flex justify-between items-center h-16 fixed w-full z-20 bg-white px-5 border-b">
            ...
            <div className="flex justify-center items-center gap-2">
                ...
                <Link to={RouteLandingPage} className="flex items-center gap-2 font-roboto font-bold text-2xl text-darkRed">
                    ...
                    <p className="w-0 md:w-full md:block font-bold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-darkRed to-midRed animate-fade-in">Frontend Task</p>
                </Link>
            </div>
        {/* sign in button */}
